...
export default function BusinessListCard({business}) {
  ...
  return (
    <TouchableOpacity style={{backgroundColor:'#fff',borderBottomLeftRadius:15,borderBottomRightRadius:15,marginTop:15}} onPress={()=>router.push('/businessdetail/'+business?.id)}>
